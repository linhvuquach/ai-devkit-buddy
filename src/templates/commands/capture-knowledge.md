...
- `ExpectedOutputFolder`: Expected output folder, use `./knowledge-base/implementation` as default
...
- Create `<ExpectedOutputFolder>/knowledge-{name}.md` using the headings implied in Step 5 (Overview, Implementation Details, Dependencies, Visual Diagrams, Additional Insights, Metadata, Next Steps)
